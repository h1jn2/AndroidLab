...
public class Test2_1Activity extends AppCompatActivity {
    ...
    // 액티비티 메뉴 구성 함수, 액티비티 초기화 되면서 한번 호출
    @Override
...
//        menu.add(0, 1, 0, "menu2");
    ...
    // 메뉴 이벤트 함수, 메개변수가 현재 이벤트 발생한 메뉴 아이템 객체
    @Override
